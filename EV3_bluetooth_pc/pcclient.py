...
#PC에 연결된 EV3의 주소는 장치 관리자 그리고 buletooth 에서 확인 가능함
SERVER = "F0:45:DA:11:EA:9A"
#"00:F4:8D:EC:A1:DC" #Bluetooth device in windows
...
your_message = mbox.read()
print(mbox.read())
print("your_message is {}.".format(your_message))
